...
const Footer = () => {
  return (
    <section className="mt-16">
      <h2 className="font-bold text-3xl text-center my-4">We are located at</h2>
      <iframe
      ...
      ></iframe>
      <div className="flex h-20 bg-secondary text-primary items-center justify-center text-base">
